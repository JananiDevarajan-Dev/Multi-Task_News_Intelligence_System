...
CLS_MODEL_PATH = "./Classification/bert_output"
LABEL_ENCODER_PATH = "./Classification/label_encoder.pkl"

# ---- Summarization paths
SUM_MODEL_PATH = "./Summarization/Transmodel/bart_Summary_finetuned"

# ---- NER paths
NER_TOKENIZER_PATH = "./NER/bert_ner_model"
NER_MODEL_PATH = "./NER/bert_ner_model"
ID2TAG_PATH = "./NER/id2tag.pkl"
...
with tab1:
    ...
    with col2:
        st.info("""
        📌 This model predicts categories Example:
        - News 
        - Sports  
        - Lifestyle  
        - Entertainment  
